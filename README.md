...
ふくし体験プログラム5本（車いす体験・白杖体験・高齢者疑似体験講座・災害ボランティアセンター運営体験・認知症サポーター養成講座）の写真は、資料に埋め込み済みです（HTMLに直接埋め込んでいるので、この1ファイルを渡すだけで写真も表示されます）。

残る防災プログラム5本には写真スロット（点線の枠）が入っています。写真ができたら、HTML内の
